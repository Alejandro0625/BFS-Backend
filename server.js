...
const prompt = [
  ...
  "   - Identify material using the legend",
  "   - Estimate width and height in real feet using the scale",
  "   - GROSS area = width x height in SF",
  "   - Subtract ALL openings: windows, doors, overhead doors, garage doors, louvers, curtainwall",
  "   - OVERHEAD/GARAGE DOORS are large — typically 10x10, 12x12, 14x14 feet — always deduct them",
  "   - When you see SEE ALTERNATE noted at a door location, still deduct that opening",
  "   - NET = Gross minus ALL openings",
  "4. SANITY CHECK: If any single zone exceeds 5000 SF recheck your scale reading",
